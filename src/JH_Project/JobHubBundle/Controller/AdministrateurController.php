...
use JH_Project\JobHubBundle\Form\AdministrateurType;

/**
 * Administrateur controller.
 *
 * @Route("/administration/administrtrateur/")
 */
class AdministrateurController extends Controller
{
     ...
     *
     * @Route("/", name="job_hub_admin_admin")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/", name="administration_administrtrateur_create")
     * @Method("POST")
     * @Template("JobHubBundle:Administrateur:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('administration_administrtrateur_show', array('id' => $entity->getId())));
        }
    ...
    */
    private function createCreateForm(Administrateur $entity)
    {
        $form = $this->createForm(new AdministrateurType(), $entity, array(
            'action' => $this->generateUrl('administration_administrtrateur_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/new", name="administration_administrtrateur_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="administration_administrtrateur_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="administration_administrtrateur_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new AdministrateurType(), $entity, array(
            'action' => $this->generateUrl('administration_administrtrateur_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="administration_administrtrateur_update")
     * @Method("PUT")
     * @Template("JobHubBundle:Administrateur:edit.html.twig")
     */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('administration_administrtrateur'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('administration_administrtrateur_delete', array('id' => $id)))
            ->setMethod('DELETE')
